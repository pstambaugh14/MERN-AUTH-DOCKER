...
docker run -d --name mern_docker_full_stack_app -p 5001:5000 -p 3000:3000 -v "${PWD}":/var/lib/jenkins/workspace/mern_docker/:ro localhost:5000/mern-auth-docker:latest
#echo ""
#echo "..... Deployment Phase Started :: Building Docker Container :: ......"
#	docker run -d -p 8180:8080 --name devops_pipeline_demo devops_pipeline_demo
